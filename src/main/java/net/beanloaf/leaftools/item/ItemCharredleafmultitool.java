...
public class ItemCharredleafmultitool extends ElementsLeafToolsMod.ModElement {
	@GameRegistry.ObjectHolder("leaf_tools:charredleafmultitool")
	public static final Item block = null;
	public ItemCharredleafmultitool(ElementsLeafToolsMod instance) {
		super(instance, 43);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("charredleafmultitool").setRegistryName("charredleafmultitool").setCreativeTab(TabLeaftools.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("leaf_tools:charredleafmultitool", "inventory"));
	}
