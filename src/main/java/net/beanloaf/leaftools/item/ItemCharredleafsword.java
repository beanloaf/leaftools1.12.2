...
public class ItemCharredleafsword extends ElementsLeafToolsMod.ModElement {
	@GameRegistry.ObjectHolder("leaf_tools:charredleafsword")
	public static final Item block = null;
	public ItemCharredleafsword(ElementsLeafToolsMod instance) {
		super(instance, 38);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("CHARREDLEAFSWORD", 3, 700, 11f, 5f, 19)) {
			@Override
		...
		}.setUnlocalizedName("charredleafsword").setRegistryName("charredleafsword").setCreativeTab(TabLeaftools.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("leaf_tools:charredleafsword", "inventory"));
	}
}
