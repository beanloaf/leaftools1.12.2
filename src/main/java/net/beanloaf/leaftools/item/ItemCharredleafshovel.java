...
public class ItemCharredleafshovel extends ElementsLeafToolsMod.ModElement {
	@GameRegistry.ObjectHolder("leaf_tools:charredleafshovel")
	public static final Item block = null;
	public ItemCharredleafshovel(ElementsLeafToolsMod instance) {
		super(instance, 41);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSpade(EnumHelper.addToolMaterial("CHARREDLEAFSHOVEL", 3, 700, 11f, -2f, 19)) {
			{
				this.attackSpeed = -3f;
			}
		...
		}.setUnlocalizedName("charredleafshovel").setRegistryName("charredleafshovel").setCreativeTab(TabLeaftools.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("leaf_tools:charredleafshovel", "inventory"));
	}
}
