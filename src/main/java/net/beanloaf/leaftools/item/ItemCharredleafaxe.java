...
public class ItemCharredleafaxe extends ElementsLeafToolsMod.ModElement {
	@GameRegistry.ObjectHolder("leaf_tools:charredleafaxe")
	public static final Item block = null;
	public ItemCharredleafaxe(ElementsLeafToolsMod instance) {
		super(instance, 40);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("charredleafaxe").setRegistryName("charredleafaxe").setCreativeTab(TabLeaftools.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("leaf_tools:charredleafaxe", "inventory"));
	}
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("CHARREDLEAFAXE", 3, 700, 11f, 6f, 19), effective_items_set);
