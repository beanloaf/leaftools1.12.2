...
public class ItemCharredleafhoe extends ElementsLeafToolsMod.ModElement {
	@GameRegistry.ObjectHolder("leaf_tools:charredleafhoe")
	public static final Item block = null;
	public ItemCharredleafhoe(ElementsLeafToolsMod instance) {
		super(instance, 42);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemHoe(EnumHelper.addToolMaterial("CHARREDLEAFHOE", 3, 700, 11f, 1f, 19)) {
		...
		}.setUnlocalizedName("charredleafhoe").setRegistryName("charredleafhoe").setCreativeTab(TabLeaftools.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("leaf_tools:charredleafhoe", "inventory"));
	}
}
