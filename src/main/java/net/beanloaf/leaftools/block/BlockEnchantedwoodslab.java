...
public class BlockEnchantedwoodslab extends ElementsLeafToolsMod.ModElement {
	@GameRegistry.ObjectHolder("leaf_tools:enchantedwoodslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("leaf_tools:enchantedwoodslab_double")
	public static final Block block_slab_double = null;
	public BlockEnchantedwoodslab(ElementsLeafToolsMod instance) {
		super(instance, 62);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("enchantedwoodslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("enchantedwoodslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("leaf_tools:enchantedwoodslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("enchantedwoodslab");
