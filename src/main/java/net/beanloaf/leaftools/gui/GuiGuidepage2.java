...
import net.beanloaf.leaftools.procedure.ProcedureGuideTTP1;
...
public class GuiGuidepage2 extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 16;
	public static HashMap guistate = new HashMap();
	public GuiGuidepage2(ElementsLeafToolsMod instance) {
		super(instance, 181);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_2.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("leaf_tools:textures/ironleafmultitoolrecipe.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 213, this.guiTop + 92, 0, 0, 181, 86, 181, 86);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("2", 5, 4, -16777216);
			this.fontRenderer.drawString("Ironmulch can be smelted into", 10, 29, -12829636);
			this.fontRenderer.drawString("Ironleaf, which creates tools and", 10, 38, -12829636);
			this.fontRenderer.drawString("equipment that are better than", 10, 47, -12829636);
			this.fontRenderer.drawString("normal iron tools.", 10, 56, -12829636);
			this.fontRenderer.drawString("Getting Started", 64, 11, -12829636);
			this.fontRenderer.drawString("Getting Started", 262, 11, -12829636);
			this.fontRenderer.drawString("You also may want to craft a", 208, 29, -12829636);
			this.fontRenderer.drawString("Ironleaf multitool, which are a", 208, 38, -12829636);
			this.fontRenderer.drawString("combined pickaxe, axe, and shovel", 208, 47, -12829636);
			this.fontRenderer.drawString("combined.", 208, 56, -12829636);
		}
		...
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureGuideTTP1.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
