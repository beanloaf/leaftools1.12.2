...
public class GuiGuidepage10 extends ElementsLeafToolsMod.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_10.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("10", 5, 4, -16777216);
			this.fontRenderer.drawString("Although there are many more", 10, 38, -12829636);
			this.fontRenderer.drawString("recipes for the Infuser, you won't", 10, 47, -12829636);
			this.fontRenderer.drawString("be able to make any without the", 10, 56, -12829636);
			this.fontRenderer.drawString("Infuser", 73, 11, -12829636);
			this.fontRenderer.drawString("Enchanted Sapling", 55, 20, -12829636);
			this.fontRenderer.drawString("other two components: the Dust", 10, 65, -12829636);
			this.fontRenderer.drawString("Extractor and Essence Condenser.", 10, 74, -12829636);
			this.fontRenderer.drawString("So for the time being, harvest the", 10, 83, -12829636);
			this.fontRenderer.drawString("entire tree and stash them away.", 10, 92, -12829636);
		}
