...
public class GuiGuidepage15 extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 28;
	public static HashMap guistate = new HashMap();
	public GuiGuidepage15(ElementsLeafToolsMod instance) {
		super(instance, 207);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_15.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("leaf_tools:textures/essencecondenserrecipe.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 213, this.guiTop + 56, 0, 0, 181, 87, 181, 87);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("15", 5, 4, -16777216);
			this.fontRenderer.drawString("Next, you'll need to make a", 10, 34, -12829636);
			this.fontRenderer.drawString("Essence Condenser.", 10, 43, -12829636);
			...
			this.fontRenderer.drawString("4x Enchantedwood Logs", 28, 83, -12829636);
			this.fontRenderer.drawString("You'll need:", 10, 74, -12829636);
			this.fontRenderer.drawString("Essence Condenser", 258, 20, -12829636);
			this.fontRenderer.drawString("4x Ironleaf", 28, 92, -12829636);
			this.fontRenderer.drawString("Essence Condenser", 51, 20, -12829636);
