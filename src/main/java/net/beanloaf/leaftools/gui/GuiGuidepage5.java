...
public class GuiGuidepage5 extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 18;
	public static HashMap guistate = new HashMap();
	public GuiGuidepage5(ElementsLeafToolsMod instance) {
		super(instance, 185);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_5.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("leaf_tools:textures/infuserbaserecipe.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 208, this.guiTop + 56, 0, 0, 179, 88, 179, 88);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("5", 5, 4, -16777216);
			this.fontRenderer.drawString("You'll need:", 10, 74, -12829636);
			this.fontRenderer.drawString("1x Nature Core", 19, 83, -12829636);
			this.fontRenderer.drawString("4x Ironleaf", 19, 92, -12829636);
			this.fontRenderer.drawString("4x Diamondleaf", 19, 101, -12829636);
			this.fontRenderer.drawString("Infuser", 73, 11, -12829636);
			this.fontRenderer.drawString("Infuser", 280, 11, -12829636);
			this.fontRenderer.drawString("The next step is to craft an Infuser", 10, 34, -12829636);
			this.fontRenderer.drawString("Base. This will be the bottom block", 10, 43, -12829636);
			this.fontRenderer.drawString("of the Infuser structure.", 10, 52, -12829636);
			this.fontRenderer.drawString("Infuser Base", 64, 20, -12829636);
			this.fontRenderer.drawString("Infuser Base", 271, 20, -12829636);
		}
