...
public class GuiLightaltargui extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiLightaltargui(ElementsLeafToolsMod instance) {
		super(instance, 167);
	}
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 79, 26) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemSolargem.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			int si;
			int sj;
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/lightaltargui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Light Altar", 60, 7, -12829636);
		}
