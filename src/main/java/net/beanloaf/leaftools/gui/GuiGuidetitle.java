...
public class GuiGuidetitle extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 14;
	public static HashMap guistate = new HashMap();
	public GuiGuidetitle(ElementsLeafToolsMod instance) {
		super(instance, 178);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidetitle.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Leaf Tools!", 163, 20, -16724992);
			this.fontRenderer.drawString("Mod made by: beanloaf", 145, 38, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 281, this.guiTop + 182, 45, 20, "ToC"));
		}
