...
import net.beanloaf.leaftools.procedure.ProcedureGuideTTP12;
...
public class GuiGuidepage11 extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 24;
	public static HashMap guistate = new HashMap();
	public GuiGuidepage11(ElementsLeafToolsMod instance) {
		super(instance, 199);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_11.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("leaf_tools:textures/dustesxtractorrecipe.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 213, this.guiTop + 47, 0, 0, 179, 87, 179, 87);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("11", 5, 4, -16777216);
			this.fontRenderer.drawString("The Dust Extractor is a block that", 10, 25, -12829636);
			this.fontRenderer.drawString("processes enchanted leaves along", 10, 34, -12829636);
			this.fontRenderer.drawString("with dust to create a new dust,", 10, 43, -12829636);
			this.fontRenderer.drawString("which can be turned into Essence", 10, 52, -12829636);
			this.fontRenderer.drawString("Dust Extractor", 60, 11, -12829636);
			this.fontRenderer.drawString("Dust Extractor", 262, 11, -12829636);
			this.fontRenderer.drawString("via Essence Extractor.", 10, 61, -12829636);
			this.fontRenderer.drawString("You'll need:", 24, 74, -12829636);
			this.fontRenderer.drawString("1x Infuser", 33, 83, -12829636);
			this.fontRenderer.drawString("4x Ironleaf", 33, 92, -12829636);
			this.fontRenderer.drawString("4x Enchantedwood Planks", 33, 101, -12829636);
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGuideTTP12.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
