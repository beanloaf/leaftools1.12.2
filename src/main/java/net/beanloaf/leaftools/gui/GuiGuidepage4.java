...
import net.beanloaf.leaftools.procedure.ProcedureGuideTTP5;
import net.beanloaf.leaftools.procedure.ProcedureGuideTTP3;
...
public class GuiGuidepage4 extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 17;
	public static HashMap guistate = new HashMap();
	public GuiGuidepage4(ElementsLeafToolsMod instance) {
		super(instance, 185);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_4.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("leaf_tools:textures/naturecorerecipe.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 208, this.guiTop + 52, 0, 0, 180, 87, 180, 87);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("4", 5, 4, -16777216);
			this.fontRenderer.drawString("You'll need:", 10, 70, -12829636);
			this.fontRenderer.drawString("4x Leaves (from vanilla trees)", 19, 79, -12829636);
			this.fontRenderer.drawString("2x Ironleaf", 19, 88, -12829636);
			this.fontRenderer.drawString("2x Goldleaf", 19, 97, -12829636);
			this.fontRenderer.drawString("1x Diamondleaf", 19, 106, -12829636);
			this.fontRenderer.drawString("Infuser", 73, 11, -12829636);
			this.fontRenderer.drawString("Infuser", 280, 11, -12829636);
			this.fontRenderer.drawString("The first step of crafting", 10, 38, -12829636);
			this.fontRenderer.drawString("the Infuser is crafting Nature", 10, 47, -12829636);
			this.fontRenderer.drawString("Make sure to craft 2 of these.", 10, 115, -12829636);
			this.fontRenderer.drawString("Nature Core", 64, 20, -12829636);
			this.fontRenderer.drawString("Nature Core", 271, 20, -12829636);
			this.fontRenderer.drawString("Cores.", 10, 56, -12829636);
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGuideTTP5.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureGuideTTP3.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
