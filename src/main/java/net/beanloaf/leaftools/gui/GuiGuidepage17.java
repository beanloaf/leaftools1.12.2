...
import net.beanloaf.leaftools.procedure.ProcedureGuideTTP16;
...
public class GuiGuidepage17 extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 30;
	public static HashMap guistate = new HashMap();
	public GuiGuidepage17(ElementsLeafToolsMod instance) {
		super(instance, 212);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_17.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("leaf_tools:textures/essencebaserecipe.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 213, this.guiTop + 56, 0, 0, 179, 87, 179, 87);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("17", 5, 4, -16777216);
			this.fontRenderer.drawString("Now that you have your Essense", 10, 34, -12829636);
			this.fontRenderer.drawString("Condenser set up, you'll need to", 10, 43, -12829636);
			...
			this.fontRenderer.drawString("4x Enchantedwood Planks", 28, 92, -12829636);
			this.fontRenderer.drawString("You'll need:", 10, 79, -12829636);
			this.fontRenderer.drawString("Essense Base", 271, 20, -12829636);
			this.fontRenderer.drawString("Essence Base", 60, 20, -12829636);
			this.fontRenderer.drawString("1x Glowstone Dust", 28, 101, -12829636);
			this.fontRenderer.drawString("craft Essense Bases to hold any", 10, 52, -12829636);
			this.fontRenderer.drawString("essence that you make.", 10, 61, -12829636);
		}
		...
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureGuideTTP16.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
