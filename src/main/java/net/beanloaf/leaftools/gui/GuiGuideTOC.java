...
import net.beanloaf.leaftools.procedure.ProcedureGuideTTTitle;
...
public class GuiGuideTOC extends ElementsLeafToolsMod.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guide_toc.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("", 5, 4, -16777216);
			this.fontRenderer.drawString("Table of Contents", 154, 11, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 19, this.guiTop + 29, 85, 20, "Introduction"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 19, this.guiTop + 56, 100, 20, "Getting Started"));
			this.buttonList.add(new GuiButton(2, this.guiLeft + 213, this.guiTop + 182, 45, 20, "Back"));
			this.buttonList.add(new GuiButton(3, this.guiLeft + 343, this.guiTop + 182, 45, 20, "Next"));
			this.buttonList.add(new GuiButton(4, this.guiLeft + 19, this.guiTop + 83, 60, 20, "Infuser"));
		}
		...
		if (buttonID == 2) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureGuideTTTitle.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 3) {
			{
