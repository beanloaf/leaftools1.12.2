...
public class GuiDustholdergui extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiDustholdergui(ElementsLeafToolsMod instance) {
		super(instance, 150);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/dustholdergui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Dustholder", 60, 7, -12829636);
		}
