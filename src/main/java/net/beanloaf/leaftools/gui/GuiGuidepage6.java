...
public class GuiGuidepage6 extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 19;
	public static HashMap guistate = new HashMap();
	public GuiGuidepage6(ElementsLeafToolsMod instance) {
		super(instance, 188);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_6.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("leaf_tools:textures/infuserrecipe.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 213, this.guiTop + 52, 0, 0, 178, 87, 178, 87);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("6", 5, 4, -16777216);
			this.fontRenderer.drawString("You'll need:", 10, 83, -12829636);
			this.fontRenderer.drawString("1x Nature Core", 19, 92, -12829636);
			this.fontRenderer.drawString("8x Ironleaf", 19, 101, -12829636);
			...
			this.fontRenderer.drawString("This will sit on top of the Infuser", 10, 43, -12829636);
			this.fontRenderer.drawString("Base.", 10, 52, -12829636);
			this.fontRenderer.drawString("Infuser", 73, 20, -12829636);
			this.fontRenderer.drawString("Infuser", 280, 20, -12829636);
		}
