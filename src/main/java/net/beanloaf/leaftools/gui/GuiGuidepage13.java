...
import net.beanloaf.leaftools.procedure.ProcedureGuideTTP14;
...
public class GuiGuidepage13 extends ElementsLeafToolsMod.ModElement {
	public static int GUIID = 26;
	public static HashMap guistate = new HashMap();
	public GuiGuidepage13(ElementsLeafToolsMod instance) {
		super(instance, 204);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("leaf_tools:textures/guidepage_13.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("leaf_tools:textures/dustrecipe.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 208, this.guiTop + 56, 0, 0, 178, 84, 178, 84);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("13", 5, 4, -16777216);
			this.fontRenderer.drawString("Now that you have 9 dust, you need", 10, 25, -12829636);
			this.fontRenderer.drawString("to condense it to use it in the", 10, 34, -12829636);
			this.fontRenderer.drawString("Essence Condenser. Simply fill a", 10, 43, -12829636);
			this.fontRenderer.drawString("crafting table grid with 9  Dust,", 10, 52, -12829636);
			this.fontRenderer.drawString("Dust Extractor", 60, 11, -12829636);
			this.fontRenderer.drawString("Dust Extractor", 262, 11, -12829636);
			this.fontRenderer.drawString("and you'll receive Packed Dust.", 10, 61, -12829636);
			this.fontRenderer.drawString("9x of any Dust", 33, 83, -12829636);
			this.fontRenderer.drawString("Make at least 4 Packed Dust before", 10, 101, -12829636);
			this.fontRenderer.drawString("You'll need:", 10, 74, -12829636);
			this.fontRenderer.drawString("moving on.", 10, 110, -12829636);
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGuideTTP14.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
