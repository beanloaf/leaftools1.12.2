...
public class ProcedureAngelicshoveldefaultbutton extends ElementsLeafToolsMod.ModElement {
	public ProcedureAngelicshoveldefaultbutton(ElementsLeafToolsMod instance) {
		super(instance, 253);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Angelicshoveldefaultbutton!");
			return;
		}
