...
public class ProcedureAngelicaxesilktouchbutton extends ElementsLeafToolsMod.ModElement {
	public ProcedureAngelicaxesilktouchbutton(ElementsLeafToolsMod instance) {
		super(instance, 242);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Angelicaxesilktouchbutton!");
			return;
		}
