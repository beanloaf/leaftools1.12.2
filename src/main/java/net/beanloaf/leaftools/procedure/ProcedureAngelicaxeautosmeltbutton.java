...
public class ProcedureAngelicaxeautosmeltbutton extends ElementsLeafToolsMod.ModElement {
	public ProcedureAngelicaxeautosmeltbutton(ElementsLeafToolsMod instance) {
		super(instance, 241);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Angelicaxeautosmeltbutton!");
			return;
		}
		...
		if (((((entity instanceof EntityLivingBase) ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY).hasTagCompound()
			...
			(((entity instanceof EntityLivingBase) ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY))
					.setStackDisplayName("§b§oAngelic Axe");
